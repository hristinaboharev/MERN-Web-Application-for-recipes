            ...
            <ul className="submenu">
              <li>
                <Link
                  ...
                  className={
                    location.pathname === "/recepti/kategorija/Doručak"
                      ? "active"
                      : ""
                  }
                >
              ...
              <li>
                <Link
                  ...
                  className={
                    location.pathname === "/recepti/kategorija/Ručak"
                      ? "active"
                      : ""
                  }
                >
              ...
              <li>
                <Link
                  ...
                  className={
                    location.pathname === "/recepti/kategorija/Večera"
                      ? "active"
                      : ""
                  }
                >
              ...
              <li>
                <Link
                  ...
                  className={
                    location.pathname === "/recepti/kategorija/Zdrav obrok"
                      ? "active"
                      : ""
                  }
                >
              ...
              <li>
                <Link
                  to="/recepti/kategorija/Dezert"
                  className={
                    location.pathname === "/recepti/kategorija/Dezert"
                      ? "active"
                      : ""
                  }
                >
